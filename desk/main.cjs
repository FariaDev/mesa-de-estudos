...
app.whenReady().then(()=>{
 ...
 app.setAboutPanelOptions({applicationName:'Mesa de Estudos',applicationVersion:'0.4.0',copyright:'© 2026 Lucas Faria. Colaboração: Grok (xAI). Licença MIT.',iconPath:path.join(__dirname,'assets','mesa-1024.png')});
